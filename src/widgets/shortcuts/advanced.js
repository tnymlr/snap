...
module.exports.Widget = new Lang.Class({
  Name: 'Snap.Shortcut.Advanced.Widget',
  GTypeName: 'SnapShortcutAdvancedWidget',
  ...
  _init: function (widget, shortcut = null) {
    ...
    this.apps = new combos.Modes(this.builder, this, shortcut)
  ...
  initBuilder: function () {
    ...
    builder.add_from_file(data.glade('snap-shortcut-advanced'))
